...
This is an unofficial tool. Note that AppRun Dedicated (専有型) is a separate service with a different API and is not supported by this tool. For AppRun Dedicated, see [fujiwara/apprun-dedicated-cli](https://github.com/fujiwara/apprun-dedicated-cli).
